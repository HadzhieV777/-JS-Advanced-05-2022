function validate() {
  ...
  function validateForm(e) {
    ...
    let confirmPasswordIsValid = confirmPasswordRegex.test(
      confirmPasswordInput.value
    );

    let checkIsPasswordsAreEqual =
      passwordIsValid &&
    ...
    let mainInputsAreValid =
      usernameIsValid &&
      isEmailValid &&
      confirmPasswordIsValid &&
      passwordIsValid;
    let companyInfoValid =
      !isCompanyCheckBox.checked ||
      (isCompanyCheckBox.checked && companyNumberIsValid);
